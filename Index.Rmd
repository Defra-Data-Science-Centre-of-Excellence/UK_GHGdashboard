...
datalibraries <- c("dplyr", "tidyr", "stringr", "purrr", "janitor", "readODS", "scales") #data reading and  manipulation
...
<<<<<<< HEAD
          type="scatter", mode= "lines", colors = colors_alphabetical
=======
          type="scatter", mode= "lines", colors = colors_alphabetically
>>>>>>> 77f40ed22b82e1afa09dad7adb1c499524719634
          ) %>%
    layout(
      title = "",
                      xaxis = list(title = ""),
